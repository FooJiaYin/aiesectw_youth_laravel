        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">{{ trans('layout.upload-file') }}</h4>
                    <small>{{ trans('layout.upload-file-detail') }}</small>
                </div>
                <div class="modal-body">
                    {!! Form::open(array('url' => '/admin/gallery/upload', 'method' => 'POST', 'files' => true, 'id' => 'uploadfile', 'class' => 'dropzone')) !!}
                        <button type="submit" class="btn btn-primary pull-right">{{ trans('layout.upload-file') }}</button>
                    {!! Form::close() !!}
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">{{ trans('layout.closee') }}</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
