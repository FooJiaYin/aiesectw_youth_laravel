    ...
    <section class="ptb ptb-60">
        <div class="container text-center animated">
            ...
            <iframe title="Accupass 報名表" marginwidth="0" marginheight="0" frameborder="0" border="0" scrolling="yes"
                    src="https://www.accupass.com/event/shareregister/1606040410331987297594" width="100%"
                    height="900px" onload="this.style.height = this.contentWindow.document.body.scrollHeight + 'px';"></iframe>
        </div>
    </section>
    <hr />
    <section class="pt">
...
@section('footer')
    ...
    <script async defer type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDvVPV8cGvJ9iEvkU5B9bvzLh7U5I00550"></script>
